...
<body class="sub_page">
  ...
  <?php
    ...
    if(isset($_POST['btnOffline'])){
      $driver->updateDriverStatus($driver->driverID, 'Offline');
    }

    if(isset($_POST['btnBusy'])){
      $driver->updateDriverStatus($driver->driverID, 'Busy');
    }

    if(isset($_POST['btnAvailable'])){
      $driver->updateDriverStatus($driver->driverID, 'Available');
    }
  ...
  $(document).ready(function(){
    ...
    function checkRequest(){
      ...
      $.ajax({
        url: "liveUpdate.php",
        method: "post",
        data: {ref:ref, driverID:driverID},
