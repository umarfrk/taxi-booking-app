        ...
        <div class="ml-lg-3">
          <?php if (isset($_SESSION['userID']) && $_SESSION['userID'] != ""): ?>
            <?php if ($_SESSION['type'] == '1'): ?>
              <a href="passengerConsole.php" class="btn btn-outline-primary btn-sm mx-2">Ride</a>
            <?php elseif ($_SESSION['type'] == '2'): ?>
              <a href="driverConsole.php" class="btn btn-outline-primary btn-sm mx-2">Driver</a>
            <?php elseif ($_SESSION['type'] == '3'): ?>
              <a href="operatorConsole.php" class="btn btn-outline-primary btn-sm mx-2">Operator</a>
            <?php elseif ($_SESSION['type'] == '4'): ?>
              <a href="adminConsole.php" class="btn btn-outline-primary btn-sm mx-2">Admin</a>
            <?php endif; ?>
