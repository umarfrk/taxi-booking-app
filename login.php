    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            ...
            <div class="card shadow-lg" style="width: 35rem ! important; max-width:600px !important">
              ...
              <div class="card-body">
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    <input type="text" name="otp" placeholder="Enter OTP Here" class="form-control" required id="otp" style="<?php if (!isset($_POST['otp'])) {
                                                                                                                                echo 'display: none;';
                  ...
                  <div class="form-group">
                    <input type="submit" name="btnSubmit" id="btnSubmit" class="form-control btn btn-sm btn-primary" style="<?php if (!isset($_POST['otp'])) {
                                                                                                                              echo 'display: none;';
                                                                                                                            } ?>">
                  </div>
                </form>
          ...
          ?>
            <div class="card shadow-lg" style="width: 35rem ! important; max-width:600px !important">
              <div class="card-hqeader">
                <h2 class="text-center">Login</h2>
              </div>
              <div class="card-body">
                <form action="" method="post">
                  <div class="form-group">
                    <input type="email" name="useremail" class="form-control" placeholder="Email " required value="<?php if (isset($_POST['useremail'])) {
                  ...
                  <div class="form-group">
                    <button class="form-control btn btn-dark" type="submit" name="btnLogin">Login</button>
                  </div>
