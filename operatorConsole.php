...
?>
          ...
          if(isset($_POST['btnSubmitReservation'])){
            ...
            $reservation->ManualReservation($_POST);
          }
          ?>
        ...
        <div class="col-md-6">
          ...
          <form action="" method="post" style="width: 100%;">
            <div class="form-group" style="display: ;">
              <input type="hidden" name="reservationType" value="Manual">
              <input type="hidden" name="reservedBy" value="<?php echo $_SESSION['userID']; ?>">
              <input type="text" name="passengerName" value="" placeholder="Enter Passenger Name" required class="form-control">
              <input type="text" name="passengerPhone" value="" required placeholder="Enter Passenger Phone" class="form-control">
              <input type="text" name="passengerNIC" value="" required placeholder="Enter Passenger NIC" class="form-control">
            </div>
            ...
            <div class="form-group">
              <input type="text" name="pickup-location" id="pickup-location" class="form-control" placeholder="FROM">
              
              <input type="text" name="dropoff-location" id="dropoff-location" class="form-control" placeholder="TO">
            </div>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if($records[$i]['status'] == "Pending"){
                      ?>
                      <a href="?code=<?php echo $records[$i]['code']; ?>" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure?')"><i class="fa fa-eye"></i> VIEW</a>
                      <?php
                    }elseif($records[$i]['status'] == "Confirmed"){
                      ?>
                      <a href="track.php?code=<?php echo $records[$i]['code']; ?>" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-street-view"></i> Track</a>
                      <?php
                    }
                    ?>
                  </td>
