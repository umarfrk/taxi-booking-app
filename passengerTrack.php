        ...
        <div class="col-md-6">
          ...
          <form action="" method="post" style="width: 100%;">
            ...
            <div class="form-group" style="display: ;">
              <input type="text" name="pickup_latitude" id="pickup_latitude" readonly value="<?php echo $pickupLat; ?>">
              <input type="text" name="pickup_longitude" id="pickup_longitude" readonly value="<?php echo $pickupLng; ?>"><br>
              <input type="text" name="dropoff_latitude" id="dropoff_latitude" readonly value="<?php echo $dropoffLat; ?>">
              <input type="text" name="dropoff_longitude" id="dropoff_longitude" readonly value="<?php echo $dropoffLng; ?>">
            </div>

            <div class="form-group">
              <label for="pickup-location">From</label>
              <input type="text" name="pickup-location" id="pickup-location" class="form-control" disabled>
              <label for="dropoff-location">To</label>
              <input type="text" name="dropoff-location" id="dropoff-location" class="form-control" disabled>
            </div>
